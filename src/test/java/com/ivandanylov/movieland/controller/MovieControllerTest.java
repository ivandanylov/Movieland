...
@SpringJUnitWebConfig(classes = {ApplicationTestConfig.class})
...
class MovieControllerTest {
    ...
    void testGetRandomMovies() throws Exception {
        ...
        when(movieServiceMock.getRandom(3)).thenReturn(movies);
        ...
        verify(movieServiceMock, times(1)).getRandom(3);
